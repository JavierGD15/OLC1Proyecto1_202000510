...
public class AFD {
    ...
    public void GRAFICARARBOL(){
        this.num = 1;
        File directorio = new File("./ARBOL_202000510");
        ...
        try
        {
            fichero = new FileWriter("./ARBOL_202000510/"+nombre+".dot");
            ...
            rt.exec("/opt/local/bin/dot -Tjpg -o ./ARBOL_202000510/"+nombre+".jpg graf ./ARBOL_202000510/"+nombre+".dot");
        }catch(IOException e){
    ...
    public void GRAFICARSIGUIENTES(){
        File directorio = new File("./SIGUIENTES_202000510/");
        if (!directorio.exists()) {
            directorio.mkdirs();
        }
        FileWriter fichero;
        ...
        try
        {
            fichero = new FileWriter("./SIGUIENTES_202000510/"+nombre+".dot");
            escritor = new PrintWriter(fichero);
            escritor.print("digraph grafica{\n"
                + "rankdir=LR;\n"
                + "forcelabels= true;\n"
            ...
            fichero.close();
            Runtime rt = Runtime.getRuntime();
            rt.exec("/opt/local/bin/dot -Tjpg -o ./SIGUIENTES_202000510/"+nombre+".jpg graf ./SIGUIENTES_202000510/"+nombre+".dot");
            //rt.exec( "dot -Tjpg -o /Users/allanbarillas/Downloads/-OLC1-Proyecto1-main/[OLC1]201903872_Proyecto1/SIGUIENTES_201903872/"+nombre+".jpg graf /Users/allanbarillas/Downloads/-OLC1-Proyecto1-main/[OLC1]201903872_Proyecto1/SIGUIENTES_201903872/"+nombre+".dot");
        }catch(IOException e){
            System.out.println("error al crear la grafica");
        }  
    }
    ...
    public void GRAFICARTRANSICIONES(){
        File directorio = new File("./TRANSICIONES_202000510");
        if (!directorio.exists()) {
            directorio.mkdirs();
        }
        FileWriter fichero;
        ...
        try
        {
            fichero = new FileWriter("./TRANSICIONES_202000510/"+nombre+".dot");
            escritor = new PrintWriter(fichero);
            escritor.print("digraph grafica{\n"
                + "rankdir=LR;\n"
                + "forcelabels= true;\n"
            ...
            fichero.close();
            Runtime rt = Runtime.getRuntime();
        rt.exec("/opt/local/bin/dot -Tjpg -o ./TRANSICIONES_202000510/"+nombre+".jpg graf ./TRANSICIONES_202000510/"+nombre+".dot");    
        //rt.exec( "dot -Tjpg -o /Users/allanbarillas/Downloads/-OLC1-Proyecto1-main/[OLC1]201903872_Proyecto1/TRANSICIONES_201903872/"+nombre+".jpg graf /Users/allanbarillas/Downloads/-OLC1-Proyecto1-main/[OLC1]201903872_Proyecto1/TRANSICIONES_201903872/"+nombre+".dot");
        }catch(IOException e){
            System.out.println("error al crear la grafica");
        }
    }
    ...
    public void GraficarAFD(){
        File directorio = new File("./AFD_202000510");
        if (!directorio.exists()) {
            directorio.mkdirs();
        }
        FileWriter fichero;
        ...
        try
        {
            fichero = new FileWriter("./AFD_202000510/"+nombre+".dot");
            escritor = new PrintWriter(fichero);
            escritor.print("digraph grafica{\n"
                + "rankdir=LR;\n"
                + "forcelabels= true;\n"
            ...
            fichero.close();
            Runtime rt = Runtime.getRuntime();
            rt.exec("/opt/local/bin/dot -Tjpg -o ./AFD_202000510/"+nombre+".jpg graf ./AFD_202000510/"+nombre+".dot");
            //rt.exec( "dot -Tjpg -o /Users/allanbarillas/Downloads/-OLC1-Proyecto1-main/[OLC1]201903872_Proyecto1/AFD_201903872/"+nombre+".jpg graf /Users/allanbarillas/Downloads/-OLC1-Proyecto1-main/[OLC1]201903872_Proyecto1/AFD_201903872/"+nombre+".dot");
        }catch(IOException e){
            System.out.println("error al crear la grafica");
        }
    }
