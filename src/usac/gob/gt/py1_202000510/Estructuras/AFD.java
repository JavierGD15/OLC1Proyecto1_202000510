...
public class AFD {
    ...
    public void GRAFICARTRANSICIONES() {
        ...
        try {
            ...
            rt.exec("dot -Tjpg -o ./TRANSICIONES_202000510/" + nombre + ".jpg graf ./TRANSICIONES_202000510/" + nombre + ".dot");
    ...
    public void GraficarAFD() {
        ...
        try {
            ...
            Runtime rt = Runtime.getRuntime();
            rt.exec("dot -Tjpg -o ./AFD_202000510/" + nombre + ".jpg graf ./AFD_202000510/" + nombre + ".dot");
    ...
    public void GRAFICARARBOL() {
        ...
        try {
            ...
            fichero.close();
            Runtime rt = Runtime.getRuntime();
            rt.exec("dot Tjpg -o ./ARBOL_202000510/" + nombre + ".jpg graf ./ARBOL_202000510/" + nombre + ".dot");
          

        } catch (IOException e) {
            System.out.println("error al crear la grafica del arbol");
        }
    }
    ...
    public String _GRAFICARARBOL(HOJA nodo, int num) {
     ...
     public void GRAFICARSIGUIENTES() {
        ...
        try {
            ...
            fichero.close();
            Runtime rt = Runtime.getRuntime();
            rt.exec("dot -Tjpg -o ./SIGUIENTES_202000510/" + nombre + ".jpg graf ./SIGUIENTES_202000510/" + nombre + ".dot");
           
        
        } catch (IOException e) {
            System.out.println("error al crear la grafica siguientes");
        }
    }
}
